...
export const PERMESSI_DEFAULT: Record<string, Record<string, boolean>> = {
  ...
  agente: {
    ...
    'admin.shippinglists.create': false, 'admin.shippinglists.index': true, 'admin.shippinglists.confirm': false, 'admin.shippinglists.print': true,
    'admin.renderlist.scan': false, 'admin.renderlist.index': false,
    'admin.pricelists.create': false, 'admin.pricelists.index': false, 'admin.pricelists.edit': false, 'admin.pricelists.delete': false, 'admin.pricelists.vector': false, 'admin.pricelists.zones.index': false, 'admin.pricelists.zones.create': false, 'admin.pricelists.zones.edit': false,
    'admin.clients.create': false, 'admin.clients.index': true, 'admin.clients.view': true, 'admin.clients.edit': false, 'admin.clients.options': false, 'admin.clients.credit': false,
