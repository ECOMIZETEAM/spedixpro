        ...
        {righe.map(r => (
          <div key={r.id} style={{ background: '#fff', border: '1px solid #fed7aa', borderRadius: '8px', padding: '12px 14px' }}>
            <div style={{ display: 'flex', flexWrap: 'wrap', alignItems: 'center', gap: '8px' }}>
              ...
              <span style={{ fontSize: '11.5px', fontWeight: 700, padding: '2px 8px', borderRadius: '20px', background: r.contratti_preferenza === 'propri' ? '#eef2ff' : '#f0fdf4', color: r.contratti_preferenza === 'propri' ? '#4338ca' : '#15803d' }}>{r.contratti_preferenza === 'propri' ? 'Porta i suoi contratti' : 'Vuole i listini MoovExpress'}</span>
              <span style={{ marginLeft: 'auto', display: 'flex', gap: '6px' }}>
