...
const DEF_SETT: Record<string,string> = { contrassegno:'si', inserimento_ritiri:'predefinito', autogenera_distinta:'predefinito', formato_stampa:'A4', zpl:'no' }
...
const CAMPI_CONTRATTO: {key:string,label:string,opts:[string,string][]}[] = [
  ...
  {key:'formato_stampa', label:'Formato di stampa', opts:[['A4','A4'],['A5','A5'],['10x15','10x15 etichetta']]},
  {key:'zpl', label:'Stampa ZPL', opts:[['no','No'],['si','Si']]},
]
