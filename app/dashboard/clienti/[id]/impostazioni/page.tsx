...
const ADMIN_FIELDS = [
  ...
  {key:'vieta_cancellazione', label:'Vieta cancellazione LDV', desc:'Se attivo, il cliente NON puo cancellare le spedizioni: te lo comunica e le cancelli tu. Vale anche per le sue chiamate API.'},
    ...
    <div>
      ...
      <div style={{marginTop:'20px',display:'flex',flexDirection:'column',gap:'20px'}}>
        ...
        {/* Rimossa la card "Formato di stampa per contratto": era finta (A4/A6/10x15 non venivano MAI
            applicati — i corrieri danno sempre un PDF). La scelta REALE PDF↔ZPL sta nella card "Stampa ZPL". */}
