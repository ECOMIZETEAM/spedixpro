            ...
            <div key={c.id} style={{display:'flex',alignItems:'center',justifyContent:'space-between',padding:'12px 18px',borderBottom:'1px solid #f5f5f5',gap:'10px'}}>
              <div style={{display:'flex',alignItems:'center',gap:'12px',flex:1,minWidth:0}}>
                {iconaCorriere(c.nome_contratto) ? (
                  ...
                  <div style={{width:'96px',height:'58px',background:'#f5f5f5',border:'1px solid #e8e8e8',borderRadius:'6px',display:'flex',alignItems:'center',justifyContent:'center',fontSize:'10px',fontWeight:'700',color:'#333',textTransform:'uppercase',flexShrink:0}}>{(isProviderTecnico(c.tipo) || c.tipo === 'generico') ? (c.nome_contratto||'').slice(0,6) : c.tipo}</div>
                )}
