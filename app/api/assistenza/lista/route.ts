...
export async function GET(_req: NextRequest) {
  ...
  const cols = 'id,oggetto,messaggio,stato,risposta,aperto_da,tipo_apertura,cliente_id,aperto_master_id,aperto_letto,categoria,pod_url,created_at,updated_at'
