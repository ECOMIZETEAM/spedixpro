...
async function apriTracking(s: any) {
  ...
  return (
    <div>
      {notifica && (
        <div style={{background:'#fee2e2', color:'#dc2626', border:'2px solid #dc2626', borderRadius:'8px', padding:'14px 18px', fontSize:'14px', fontWeight:'700', marginBottom:'16px', textAlign:'center'}}>{notifica}</div>
      )}
