...
export default function ClienteListinoPage() {
  ...
  return (
    <div>
      ...
      <p style={{ fontSize: '13px', color: '#8a8a8a', margin: '0 0 18px' }}>Clicca su un contratto per aprirne il listino. Sola lettura.</p>
              ...
              <div key={id} style={{ background: '#fff', borderRadius: '10px', border: aperto ? '1px solid #f97316' : '1px solid #e5e7eb', overflow: 'hidden', boxShadow: aperto ? '0 1px 3px rgba(249,115,22,0.12)' : 'none' }}>
                ...
                {aperto && (
                  <div style={{ borderTop: '1px solid #eee' }}>
                    <div style={{ padding: '10px 16px 0', display: 'flex', alignItems: 'center', justifyContent: 'space-between', gap: '10px', flexWrap: 'wrap' }}>
                      <span style={{ fontSize: '11.5px', color: '#8a8a8a' }}>Fattore Peso/Volume: <b style={{ color: '#1a1a1a' }}>1/{c.fattore}</b></span>
                    </div>
                    {/* Tab bar del contratto (come il listino corriere del master) */}
