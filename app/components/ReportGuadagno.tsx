...
export default function ReportGuadagno({ titolo = 'Report Guadagno Spedizioni', endpoint = '/api/reports/guadagno' }: { titolo?: string, endpoint?: string }) {
      ...
      <div style={{ padding: '18px', display: 'grid', gridTemplateColumns: '1.4fr 1fr 1fr', gap: '14px' }}>
        ...
        <div style={{ background: '#f9fafb', border: '1px solid #eef0f2', borderRadius: '10px', padding: '16px 18px' }}>
          <div style={{ display: 'flex', alignItems: 'center', gap: '7px' }}>
            ...
            <span style={{ fontSize: '10.5px', fontWeight: 700, textTransform: 'uppercase', letterSpacing: '.5px', color: '#8a8a8a' }}>Costo</span>
          </div>
